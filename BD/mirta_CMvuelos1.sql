...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-07-2024 a las 01:44:55
...
(0, 0, 'Cesar', 'Aponte', 'AX456TY', '0000-00-00 00:00:00.000000', '2024-07-09');
...
--
ALTER TABLE `vuelo`
  ADD CONSTRAINT `vuelo_ibfk_1` FOREIGN KEY (`PilotoID`) REFERENCES `piloto` (`PilotoID`) ON UPDATE CASCADE;
COMMIT;
